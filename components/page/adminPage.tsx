          ...
          <div className="relative flex items-center justify-between gap-3 md:justify-end">
            ...
            {showDropdown && (
              <>
                ...
                <div className="absolute right-0 top-[52px] z-[90] w-56 overflow-hidden rounded-2xl border-[.5px] border-blue-500 bg-white shadow-2xl shadow-slate-200 md:top-[60px] md:w-64 md:rounded-3xl">
